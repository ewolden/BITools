...
if ($isFolder) {
    ...
    if ($template.variables -match "Microsoft.DataFactory/factories/") {
        # This is a data factory template 
    ...
    elseif ($template.variables -match "Microsoft.Synapse/workspaces/") {
        # This is a synapse template
